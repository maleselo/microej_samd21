 ...
 * It provides some methods to create internal MicroUI events which
 * target MicroUI event generators implementations.
 */
#ifndef _LLINPUT
#define _LLINPUT 
...
/**
 * Specifies the pointer coordinates are absolute
 */
#define LLINPUT_ABSOLUTE (0)

/**
 * Specifies the pointer coordinates are relative to the previous pointer position
 */
#define LLINPUT_RELATIVE (1)
 ...
 * @param eventGeneratorID the MicroUI <code>EventGenerator</code> event generator ID
 * @param event the 32-bit event
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendEvent(int32_t eventGeneratorID, int32_t event);
 ...
 */
int32_t LLINPUT_sendEvents(int32_t eventGeneratorID, int32_t* eventsArray, int32_t length);
 ...
 * @param commandsEventGeneratorID the MicroUI <code>Command</code> event generator ID
 * @param command the command to send, between 0 and 255
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendCommandEvent(int32_t commandsEventGeneratorID, int32_t command);
 ...
 * @param buttonsEventGeneratorID the MicroUI <code>Buttons</code> event generator ID
 * @param buttonId the button ID, between 0 and 255
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendButtonPressedEvent(int32_t buttonsEventGeneratorID, int32_t buttonId);
 ...
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendButtonReleasedEvent(int32_t buttonsEventGeneratorID, int32_t buttonId);
 ...
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendButtonRepeatedEvent(int32_t buttonsEventGeneratorID, int32_t buttonId);
 ...
 * prevent unexpected behavior.
 * @param pointerEventGeneratorID the MicroUI <code>Pointer</code> event generator ID
 * @param buttonId the button ID, between 0 and 255
 ...
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendPointerPressedEvent(int32_t pointerEventGeneratorID, int32_t buttonID, int32_t x, int32_t y, int32_t type);
 ...
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendPointerReleasedEvent(int32_t pointerEventGeneratorID, int32_t buttonID);
 ...
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendPointerMovedEvent(int32_t pointerEventGeneratorID, int32_t x, int32_t y, int32_t type);
 ...
 * caller should not send next RELEASED event (and potential MOVE event(s)) to 
 * prevent unexpected behavior.
 * @param touchEventGeneratorID the MicroUI <code>Touch</code> event generator ID
 * @param x the pointer X coordinate
 * @param y the pointer Y coordinate
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendTouchPressedEvent(int32_t touchEventGeneratorID, int32_t x, int32_t y);
 ...
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendTouchReleasedEvent(int32_t touchEventGeneratorID);
 ...
 * event generator (tag <code>&lt;touch&gt;</code> in microui xml file). <br>
 * The event will not be added if the internal events buffer is full.
 * @param touchEventGeneratorID the MicroUI <code>Pointer</code> event generator ID
 * @param x the pointer X coordinate
 * @param y the pointer Y coordinate
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendTouchMovedEvent(int32_t touchEventGeneratorID, int32_t x, int32_t y);
 ...
 * The event will not be added if the internal events buffer is full.
 * @param statesEventGeneratorID the MicroUI <code>States</code> event generator ID
 ...
 * @return {@link LLINPUT_OK} if the event has been added, {@link LLINPUT_NOK} otherwise
 */
int32_t LLINPUT_sendStateEvent(int32_t statesEventGeneratorID, int32_t stateID, int32_t stateValue);
